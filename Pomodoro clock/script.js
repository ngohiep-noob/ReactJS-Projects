...
class App extends React.Component{
    ...
    handleReset() {
        ...
        // window.clearInterval(timeCounter.timerId)
        timeCounter = undefined;
    }
    componentDidUpdate() {
    ...
    render() {
        return(
            <div className="app">
                ...
                <div className="footer">Coded by  
                    <a 
                    href="https://codepen.io/Ngohiep" className="contact-link"
                    target="_blank"> Ngo Hiep</a>
                </div>
                    ...
                    <div className="length-control-box">
                        ...
                        <button 
                          ...
                          onClick = {this.props.handleDecreate}>
                            <i 
                            className="fa fa-arrow-down" aria-hidden="true"
